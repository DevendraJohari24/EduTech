    ...
    <nav className="relative container mx-auto p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-20">
            <div className="flex">
                    <p className="text-3xl italic font-bold text-gray-700">EduTech</p>
            </div>
          <div className="hidden space-x-8 font-bold lg:flex">
            <NavLink to="/about" className="text-grayishViolet hover:text-veryDarkViolet"
              >About</NavLink
            >
            <NavLink to="/features" className="text-grayishViolet hover:text-veryDarkViolet"
              >Features</NavLink
            >
            <NavLink to="/testimonials" className="text-grayishViolet hover:text-veryDarkViolet"
        ...
        >
          ...
          <a
            href="#"
            className="px-8 py-3 font-bold text-white bg-gray-700 rounded-full hover:opacity-70"
            >Sign Up</a
          >
        </div>
